...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-6">
      {/* Live Badge - Top Left */}
      ...
      {/* Hero Content */}
      <div className="relative z-10 text-center max-w-6xl mx-auto py-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-[-10px]">
