    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-4">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto -mt-24">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12 mt-16">
          <button className="group relative bg-[#ffc5f4] hover:bg-[#ff6b9d] text-white font-black py-6 px-12 rounded-2xl text-xl transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 border-4 border-white/20 overflow-hidden w-64">
            {/* Button glow effect */}
            <div className="absolute inset-0 bg-[#ffc5f4] opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
            Watch Latest Pull
          </button>
          
          <button className="group relative bg-white/10 backdrop-blur-md hover:bg-white/20 text-white font-black py-6 px-12 rounded-2xl text-xl transition-all duration-300 shadow-2xl hover:shadow-3xl border-4 border-white/30 hover:border-[#fa98d4] overflow-hidden w-64">
            {/* Button glow effect */}
